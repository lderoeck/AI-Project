...
def evaluate_recommender(metric: str, tfidf: str, use_feedback=False, qual_eval_folder='./evaluation', normalize=False, read_max=None) -> tuple:
    ...
    """
    rec = ContentBasedRec("./data/steam_games.json", sparse=True, distance_metric=metric, tfidf=tfidf, use_feedback=use_feedback, normalize=normalize)
